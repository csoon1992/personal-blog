...
function Hero() {
    return (
        <div id="hero" className="w-full h-screen flex flex-col">
            <div className="menu sticky top-0 py-8 bg-white">
            ...
            <div className="container flex-1 grid grid-cols-5 gap-20 justify-end items-center pt-8 mx-auto">
                ...
                <div className="col-span-2 h-full relative">
                    <img
                        src={mePhoto}
                        alt='Cristina Soler'
                        className='profile-photo absolute bottom-0'
                    />
                </div>
                ...
                <div className="content col-span-3 col-start-3 col-end-5">
                    <div className="">
                        ...
                        <h2 className="text-5xl text-black my-4">Soy <span className="text-primary">Cristina</span> Soler</h2>
