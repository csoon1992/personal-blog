      ...
      <Container>
        <div className="about-content mx-0">
          ...
          <section className="presentation mb-5">
            ...
            <p>En mi tiempo libre, me dedico a aprender otras tecnologías totalmente ajenas al comercio electrónico, pues mi objetivo a medio-largo plazo es centrarme en Laravel + React.js.</p>
          </section>
              ...
              <Row className="company-header d-flex align-items-strech mb-3 mx-0">
                ...
                <Col className="d-flex align-items-center">
                  <div className="py-1">
                    ...
                    <UncontrolledCollapse className="pb-2" toggler="#redegal-toggler">
                ...
                <Col className="col-auto d-flex align-items-center">
                  <Button className="unstyled-btn toggler-btn rounded-circle p-0" id="redegal-toggler">
              ...
              <Row className="company-header d-flex align-items-strech mb-3 mx-0">
                ...
                <Col className="d-flex align-items-center">
                  <div className="py-1">
                    ...
                    <UncontrolledCollapse className="pb-2" toggler="#wetaca-toggler">
                      <Card className="border-0">
                        <CardBody className="px-0 pb-0">
                          <div className="tasks">
                            <p className="mb-0">Tareas:</p>
                ...
                <Col className="col-auto d-flex align-items-center">
                  <Button className="unstyled-btn toggler-btn rounded-circle p-0" id="wetaca-toggler">
                    <IconContext.Provider value={{ className: 'icon'}}>
                      <MdKeyboardArrowDown />
                    </IconContext.Provider>
                  </Button>
              ...
              <Row className="company-header d-flex align-items-strech mb-3 mx-0">
                ...
                <Col className="d-flex align-items-center">
                  <div className="py-1">
                    ...
                    <UncontrolledCollapse className="pb-2" toggler="#cbi-toggler">
                      <Card className="border-0">
                        <CardBody className="px-0 pb-0">
                          <div className="tasks">
                            <p className="mb-0">Tareas:</p>
                ...
                <Col className="col-auto d-flex align-items-center">
                  <Button className="unstyled-btn toggler-btn rounded-circle p-0" id="cbi-toggler">
                    <IconContext.Provider value={{ className: 'icon'}}>
                      <MdKeyboardArrowDown />
                    </IconContext.Provider>
                  </Button>
